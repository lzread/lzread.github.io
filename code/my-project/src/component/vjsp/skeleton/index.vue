<template>
	<view class="vw-skeleton-cmomon vw-skeleton-box" :style="{width: winWidth+'px', height:winHeight+'px', backgroundColor:backgroundColor}">
		...
		<view class="vw-loading" :class="[getLoadingType(loadingType)]" v-if="isLoading"></view>
	</view>
</template>
...
<style scoped>
	...
	.vw-loading {
		...
		border-radius: 50%;
		border: 2px solid;
		animation: vw-rotate 0.7s linear infinite;
		position: fixed;
		z-index: 999999;
		left: 50%;
		top: 50%;
