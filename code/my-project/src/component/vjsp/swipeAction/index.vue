<template>
  <view class="vw-swipe-action" :style="{ backgroundColor: backgroundColor }">
    <view class="vw-swipe-action_item" :class="[isShowBtn ? 'vw-swipe-action_item_show' : '']" @touchstart="handlerTouchstart" @touchmove="handlerTouchmove" @touchend="handlerTouchend" @mousedown="handlerTouchstart" @mousemove="handlerTouchmove" @mouseup="handlerTouchend" :style="{ transform: 'translate(' + position.pageX + 'px,0)' }">
      <view class="vw-swipe-action_content">
        <slot name="content"></slot>
      </view>
      <view class="vw-swipe-action_button_right_group" v-if="actions.length > 0" @touchend.stop="loop">
        <view class="vw-swipe-action_button_right_item" v-for="(item, index) in actions" :key="index" :style="{ backgroundColor: item.background || '#f7f7f7', color: item.color, width: item.width + 'px' }" :data-index="index" @tap="handlerButton">
