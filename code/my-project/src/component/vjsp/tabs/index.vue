<template>
	<view
		class="vw-tabs"
		:class="[isFixed ? 'vw-tabs-fixed' : 'vw-tabs-relative', unlined ? 'vw-unlined' : '']"
		:style="{
			width: tabsWidth + 'px',
			height: height + 'rpx',
	...
	>
		<view v-for="(item, index) in tabs" :key="index" class="vw-tabs-item" :style="{ width: itemWidth }" @tap.stop="swichTabs(index)">
			<view
				class="vw-tabs-title"
				:class="{ 'vw-tabs-active': currentTab == index, 'vw-tabs-disabled': item.disabled }"
				:style="{
